...
import net.minecraft.item.Item;
 ...
 public class valcoin {
     public static void init() {
         ...
         GameRegistry.registerItem(diamondvalcoin, "diamondvalcoin");
         ...
         GameRegistry.registerItem(ironvalcoin, "ironvalcoin");
         ...
         GameRegistry.registerItem(goldvalcoin, "goldvalcoin");
     }
 }
